...
public class PopupFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        nameText = rootView.findViewById(R.id.frag_popup_name_textview);
        descriptionText = rootView.findViewById(R.id.frag_popup_description_textview);
        calorieText = rootView.findViewById(R.id.frag_popup_calorie_textview);
        imageView = rootView.findViewById(R.id.fragment_popup_iv);
        progressBar = rootView.findViewById(R.id.fragment_popup_prog);
